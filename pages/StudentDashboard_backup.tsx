...
const StudentDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-full font-sans flex flex-col relative overflow-x-hidden" style={{ backgroundColor: '#D9F3D5' }}>
      ...
      {/* Header */}
      <header className="relative z-20 bg-[#A1D9AE] border-b-4 border-brand-brown py-4 px-6 flex justify-between items-center shadow-md">
        {/* Logo placeholder */}
        <div className="w-32 h-16 bg-white/80 border-2 border-brand-brown rounded-xl flex items-center justify-center">
          <span className="text-xs font-bold text-brand-brown">LOGO</span>
        </div>

        <div className="text-center">
          <h1 className="text-4xl font-black text-brand-brown font-rounded tracking-wider">LP科樂園</h1>
          <p className="text-sm font-bold text-brand-brown/80">李炳科學AI學習平台</p>
        </div>
